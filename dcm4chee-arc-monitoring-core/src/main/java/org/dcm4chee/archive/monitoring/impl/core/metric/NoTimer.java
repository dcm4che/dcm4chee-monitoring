 ...
 *
 */
public class NoTimer extends AbstractMetric implements Timer {
    public static final NoTimer INSTANCE = new NoTimer();
    
    private final NoSplit noSplit = new NoSplit();
    ...
    private static class NoSplit implements Timer.Split {
