...
package org.dcm4chee.archive.monitoring.impl.core.registry;
...
public class MetricFilters {
	...
	public static final MetricFilter TIMER_FILTER = new MetricFilter() {
		@Override
		public boolean matches(MonitoringContext cxt, Metric metric) {
			return metric instanceof Timer;
		}
	};
	
	public static final MetricFilter COUNTER_FILTER = new MetricFilter() {
		@Override
		public boolean matches(MonitoringContext cxt, Metric metric) {
	...
	public static final MetricFilter ALL_FILTER = new MetricFilter() {
		@Override
		public boolean matches(MonitoringContext cxt, Metric metric) {
			return true;
		}
