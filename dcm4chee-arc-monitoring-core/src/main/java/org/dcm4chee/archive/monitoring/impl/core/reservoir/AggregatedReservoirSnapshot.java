 ...
 *
 */
public interface AggregatedReservoirSnapshot extends ReservoirSnapshot {
    ...
    void setMeanRateCalculatiuonMethod(MEAN_RATE_CALC_METHOD meanRateCalcMethod);
    
    double getMeanRate(long resolution, UnitOfTime timeUnit);
