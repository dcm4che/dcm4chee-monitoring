 ...
 *
 */
public class ManualClock extends UserTimeClock {
	private final long startTick;
	private final long tickSize;
	private long currentTick;

	public ManualClock(long startTick, long tickSize, UnitOfTime timeUnit) {
		this.startTick = startTick;
		this.tickSize = timeUnit.toNanos(tickSize);
		currentTick = timeUnit.toNanos(startTick);
	}
	...
	@Override
    public long getTime() {
        return UnitOfTime.NANOSECONDS.toMillis(currentTick);
    }
