...
public class Configuration {
    ...
    public void setRegistryConfiguration(MetricRegistryConfiguration registryConfiguration) {
    ...
    public List<MetricReservoirConfiguration> getMetricReservoirConfigurations() {
        return metricReservoirConfigurations;
    }

    public void setMetricReservoirConfigurations(List<MetricReservoirConfiguration> metricReservoirConfigurations) {
        this.metricReservoirConfigurations = metricReservoirConfigurations;
    }
