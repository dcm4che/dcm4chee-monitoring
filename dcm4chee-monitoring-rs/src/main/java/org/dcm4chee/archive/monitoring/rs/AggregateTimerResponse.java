 ...
 *
 */
public class AggregateTimerResponse extends MetricResponse {
	private final UnitOfTime timeUnit;
	private long size;
	
	private AggregateTimerResponse(UnitOfTime timeUnit) {
		this.timeUnit = timeUnit;
	}
	
	public static AggregateTimerResponse create(AggregateSnapshot snapshot, UnitOfTime timeUnit) {
		AggregateTimerResponse response = new AggregateTimerResponse(timeUnit);
	...
	public static AggregateTimerResponse create(AggregatedReservoirSnapshot snapshot, UnitOfTime timeUnit) {
		AggregateTimerResponse response = new AggregateTimerResponse(timeUnit);
		response.setPath(snapshot.getPath());
